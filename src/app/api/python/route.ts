...
import Python from '@/src/models/python'
...
export async function GET(request: NextRequest) {
  try {
    ...
    const topics = await Python.find(query)
...
export async function POST(request: NextRequest) {
  try {
    ...
    const newTopic = new Python({ title, description })
    ...
    console.error('Error in POST /api/python:', errorMessage)
